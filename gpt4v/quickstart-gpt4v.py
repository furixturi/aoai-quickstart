...
response = client.chat.completions.create(
    ...
    messages = [
        ...
        {"role": "system", "content": "You are a helpful multilingual assistant trained to interpret images and can make responsible assumptions about people and places."}, # https://community.openai.com/t/calls-to-gpt-4-vision-preview-dont-produce-errors-but-it-says-it-cant-read-images/478203/6
        {"role": "user", "content": [
            {
                "type": "text",
